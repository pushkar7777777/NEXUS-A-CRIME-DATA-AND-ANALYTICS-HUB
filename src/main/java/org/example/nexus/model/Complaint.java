...
public class Complaint {
    ...
    // Note: The status codes should be consistent, e.g., "FILED", "UNDER_REVIEW", "UNDER_INVESTIGATION", "RESOLVED"

    // Getters and Setters (omitted for brevity, but exist as provided in your original code)
    ...
    public String getVictimDetails() { return victimDetails; }
    public void setVictimDetails(String victimDetails) { this.victimDetails = victimDetails; }
